...
async function POST_leader(data) {
  ...
  const SQLquery =
    await `INSERT INTO ct_leader (LEADER_UID, LEADER_NAME, LEADER_IMAGE, LEADER_CAPACITY, LEADER_PRICE, LEADER_AMOUNT, EXCHANGE_TYPE, ACCESS_KEY, SECRET_KEY, TRADER_ST, REG_DT, MOD_DT, AVG_BUY_PRICE) VALUES (${LEADER_UID}, '${LEADER_NAME}', '${LEADER_IMAGE}', '${LEADER_CAPACITY}', '${LEADER_PRICE}', '${LEADER_AMOUNT}','${EXCHANGE_TYPE}', '${ACCESS_KEY}', '${SECRET_KEY}','${TRADER_ST}','${REG_DT}','${MOD_DT}','${AVG_BUY_PRICE}');`;
